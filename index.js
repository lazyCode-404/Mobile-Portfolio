...
const projects = [
  {
    ...
    liveLink: 'https://bwalyanonde.github.io/Capstone-Web-Project-1/',
    sourceLink: 'https://github.com/BwalyaNonde/Capstone-Web-Project-1',
  },
  {
    id: 1,
    name: 'Awesome Books',
    description:
      'A Booklist App is a library that allows users to upload books which are displayed as a list, and one is able to remove uploaded books.',
    img: 'modules.png',
    language1: 'CSS',
    language2: 'HTML',
    language3: 'bootstrap',
    language4: 'JavaScript',
    liveLink: 'https://bwalyanonde.github.io/Awesome-Books/',
    sourceLink: 'https://github.com/BwalyaNonde/Awesome-Books',
  },
  {
    id: 2,
    name: 'To Do List',
    description:
      'A TO DO List was developed to allow a user to add tasks that need to be done and cancle or delete ones that have been completed.',
    img: 'to-do-list.png',
    language1: 'CSS',
    language2: 'HTML',
    language3: 'bootstrap',
    language4: 'JavaScript',
    liveLink: 'https://bwalyanonde.github.io/To-do-list/',
    sourceLink: 'https://github.com/BwalyaNonde/To-do-list',
  },
  {
    id: 3,
